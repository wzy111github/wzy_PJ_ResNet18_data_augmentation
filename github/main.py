...
def main():
    ...
    num_thread=2#线程数，如果线程数大于零时没有报错“broken pipe”，可设置一个大于零的数来加速训练
    ...
    # 超参数设置
    epochs = 50 # 遍历数据集次数
    BATCH_SIZE = 64  # 批处理尺寸(batch_size)#在加载预训练权重时可能由于内存不够需要减小此参数
    lr = 0.1  # 初始学习率
    ...
    for epoch in range(epochs):
        ...
        # 保存权重
    torch.save(net.state_dict(), save_weights+"/{}_model-{}.pth".format(method,epochs))
